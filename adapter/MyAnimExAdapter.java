...
import com.demo.expandablelistviewdemo.base.MyAnimBaseExAdapter;
 ...
 * @描述： TODO
 */
public class MyAnimExAdapter extends MyAnimBaseExAdapter {

    private boolean mChildClickEnable;

    public MyAnimExAdapter(List<GroupBean> data, Context context) {
        super(data, context);
    }
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        groupHolder.iv_arrow.setImageResource(groupBean.isOpen() ? R.drawable.arrow_open : R.drawable.arrow);
        return convertView;
    }
